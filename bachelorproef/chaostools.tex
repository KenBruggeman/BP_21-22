...
# Link: https://github.com/chaostoolkit/chaostoolkit-kubernetes
...
Men hoeft de configuratie niet noodzakelijk te bekomen via het 'chaos init' commando maar kan een experiment ook opzetten via een vooraf gedefinieerd YAML-bestand. Creëer een nieuw bestand genaamd 'random-pod-kill.yaml' m.b.v. een teksteditor naar keuze. 

In volgende link kan men een voorgedefinieerde YAML-definitie vinden die men in het bestand kan overnemen: \href{https://github.com/KenBruggeman/BP\textunderscore 21-22/blob/master/bachelorproef/docs/chaostoolkit%20experimenten/random-pod-kill.yaml}{Experiment 1: random-pod-kill.yaml}

Om het experiment te herhalen m.b.v. deze YAML-definitie voert men commando {\bf chaos run random-pod-kill.yaml} uit. 

TO DO: figure van k9s uitvoer !!! 
