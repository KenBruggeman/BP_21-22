...
Nota: Men kan nodes vrijwaren om pods toegewezen te krijgen via taints en tolerations. 
...
In volgend hoofdstuk zal een Kubernetes cluster via Google Cloud opgezet worden, om enerzijds te vergelijken als de setup vlotter verloopt en anderzijds de extra functionaliteit in kaart te brengen die deze omgeving met zich meebrengt.